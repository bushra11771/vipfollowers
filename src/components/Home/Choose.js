  ...
  <div className="section">
    <div className="shell shell--medium">
      <div className="section__head">
        <h6>Vip Follower's Instagram Packages</h6>
        <h2>
        {data.text22 && Parser(data.text22)}
        </h2>
        <p>
        {data.text23 && Parser(data.text23)}
        </p>
      </div>
        ...
        <div className="callout__content">
          <div className="flex-row lg-cols-1">
            <div className="flex-col">
              <p>
              {data.text24 && Parser(data.text24)}
              </p>
            </div>
          </div>
        </div>
            ...
            <div className="service text-sm service--cyan">
              <div className="service__inner">
                <div className="service__entry">
                  ...
                  <p>
                  {data.text25 && Parser(data.text25)}
                  </p>
                </div>
            ...
            <div className="service text-sm service--purple">
              <div className="service__inner">
                <div className="service__entry">
                  ...
                  <p>
                  {data.text26 && Parser(data.text26)}
                  </p>
                </div>
                <div className="offer has-stars">
            ...
            <div className="service text-sm service--yellow">
              <div className="service__inner">
                <div className="service__entry">
                  ...
                  <p>
                  {data.text27 && Parser(data.text27)}
                  </p>
                </div>
                <div className="offer has-stars">
